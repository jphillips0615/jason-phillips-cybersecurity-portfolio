      ...
      <div className="relative z-10 mx-auto max-w-6xl px-5 py-10 sm:py-14 lg:px-8">
        ...
        <section className="mt-16 grid gap-5 lg:grid-cols-2">
          ...
          <div className="panel-card">
            ...
            <p className="mt-5 text-sm leading-6 text-cyber-muted">The goal was not simply to block traffic, but to prove that the rule was narrow enough to preserve DNS and file-sharing functionality.</p>
          </div>
        </section>
